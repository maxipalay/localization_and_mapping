...
struct OptimizerConfig
{
  ...
  double between_rotation_sigma_rad{0.05};  // Rotation sigma for consecutive-keyframe between factors.
  double tag_translation_sigma_m{0.10};  // Translation sigma for body-to-tag observation factors.
  double tag_rotation_sigma_rad{1.0};  // Rotation sigma for body-to-tag observation factors.
  ...
  double tag_anchor_rotation_sigma_rad{0.35};  // Rotation sigma of the anchor-tag prior.
  ...
  double anchor_translation_sigma_m{0.30};  // Translation sigma of the fallback first-keyframe anchor.
  double anchor_rotation_sigma_rad{0.50};  // Rotation sigma of the fallback first-keyframe anchor.
  double tag_observation_huber_k{1.345};  // Huber loss threshold for tag observation factors.
};
